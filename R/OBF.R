...
OBF_2_RAR_A1 <- function(n,norep) {
  ...
  for (m in 1:length(eta_vector))
  {
    ...
    for (i in 1:norep)
    {
      ...
      wert_2 = cubature::pcubature(f, c(-grobf_1, -Inf), c(grobf_1, -grobf_2))$integral
      wert_3 = cubature::pcubature(f, c(-grobf_1, grobf_2), c(grobf_1, Inf))$integral
...
OBF_3_RAR_A1 <- function(n,norep) {
  ...
  for (m in 1:length(eta_vector))
  {
    ...
    for (i in 1:norep)
    {
      ...
      wert_4 = cubature::pcubature(f, c(-grobf_1, -grobf_2, -Inf), c(grobf_1, grobf_2, -grobf_3))$integral
      wert_5 = cubature::pcubature(f, c(-grobf_1, -grobf_2, grobf_3), c(grobf_1, grobf_2, Inf))$integral
